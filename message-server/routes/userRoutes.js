...
const { login , register, getMyProfile, logout, searchUser, sendFriendRequest, acceptRequest , getNotifications, getAllFriends} =require('../controllers/userControllers');
